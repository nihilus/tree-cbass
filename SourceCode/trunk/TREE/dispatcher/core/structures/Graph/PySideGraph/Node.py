...
class Node(QGraphicsItem):
    ...
    def contentSceneRect(self):
        ...
        return QtCore.QRect(int(self.contentPos.x()), int(self.contentPos.y()), self.w, self.h)
    
    def contentSceneRectF(self):
        from PySide import QtGui, QtCore
        return QtCore.QRectF(self.contentPos, QtCore.QSize(self.w, self.h))    
    ...
    def drawLine(self, painter, sourceRect, destRect):
        ...
        self.lineRect = QtCore.QRectF(sourcePoint, destPoint)
